...
2. **For each task:**
   ...
   - If implementer asks questions: answer, then let them proceed
   - Implementer implements, tests, commits, self-reviews
   - Dispatch spec reviewer subagent - confirms code matches spec
   - If spec issues: implementer fixes, re-review until spec compliant
   - Dispatch code quality reviewer subagent
   - If quality issues: implementer fixes, re-review until approved
   - Mark task complete
